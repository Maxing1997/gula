#include "gula/net/TcpConnection.h"
#include "gula/base/Logging.h"
#include "gula/base/WeakCallback.h"
...
void gula::net::defaultConnectionCallback(const TcpConnectionPtr& conn)
{
...
void gula::net::defaultMessageCallback(const TcpConnectionPtr&,
                                        Buffer* buf,
                                        Timestamp)
{
  buf->retrieveAll();
